...
const BaseMapGallery = () => {
    ...
    return <ul style={{ ...basemapGalleryStyles }} >
        {list.map((b) => <BasemapCard key={b.label} basemap={b} selected={splitAtLastSlash() === b.basemap_id} handleChange={handleChange} />)}
    </ul>
}
    ...
    return (
        <li style={basemapCardStyles} onClick={() => handleChange(basemap)}>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
                <img style={basemapImage(!!selected)} src={thumbnail} alt="basemap thumbnail" />
...
const list: BasemapStyle[] = JSON.parse(JSON.stringify([
    {
        "id": "10",
        "basemap_id": "satellite-streets-v12",
        "label": "Satellite Streets",
        "thumbnail": "https://res.cloudinary.com/hmelwryln/image/upload/c_scale,h_400,q_auto:good/v1698353662/gis-gallery/mapbox-satellite-streets.png",
        "source": "mapbox",
        "layers": [
            {
                "type": "mapbox_tiles",
    ...
    {
        "id": "9",
        "basemap_id": "satellite-v9",
        "label": "Satellite",
        "thumbnail": "https://res.cloudinary.com/hmelwryln/image/upload/c_scale,h_400,q_auto:good/v1698353662/gis-gallery/mapbox-satellite.png",
        "source": "mapbox",
        "layers": [
            {
                "type": "mapbox_tiles",
    ...
    {
        "id": "5",
        "basemap_id": "streets-v12",
        "label": "Streets",
        "thumbnail": "https://res.cloudinary.com/hmelwryln/image/upload/c_scale,h_400,q_auto:good/v1698353662/gis-gallery/mapbox-streets.png",
        "source": "mapbox",
        "layers": [
            {
                "type": "mapbox_tiles",
    ...
    {
        "id": "6",
        "basemap_id": "outdoors-v12",
        "label": "Outdoors",
        "thumbnail": "https://res.cloudinary.com/hmelwryln/image/upload/c_scale,h_400,q_auto:good/v1698353662/gis-gallery/mapbox-outdoors.png",
        "source": "mapbox",
        "layers": [
            {
                "type": "mapbox_tiles",
                "mapbox": "mapbox://styles/mapbox/outdoors-v12"
            }
        ]
    },
    {
        "id": "7",
        "basemap_id": "light-v11",
        "label": "Light",
        "thumbnail": "https://res.cloudinary.com/hmelwryln/image/upload/c_scale,h_400,q_auto:good/v1698353662/gis-gallery/mapbox-light.png",
        "source": "mapbox",
        "layers": [
            {
                "type": "mapbox_tiles",
    ...
    },
    {
        ...
        "basemap_id": "dark-v11",
        "label": "Dark",
        "thumbnail": "https://res.cloudinary.com/hmelwryln/image/upload/c_scale,h_400,q_auto:good/v1698353662/gis-gallery/mapbox-dark.png",
        "source": "mapbox",
        "layers": [
            {
                "type": "mapbox_tiles",
